...
// func CreateCF(elements *[]ck_pir.Row) (cf *cuckoo.Filter) {
// 	// Create CF
...
// // bucketLen = 12
// func CFSegment(cf *cuckoo.Filter, numSeg uint32, segSize uint32, bucketLen int) *ck_pir.StaticDB {
// 	buckets := cf.BucketsSlice(uint64(numSeg*segSize), uint64(segSize))
// 	ShrinkCapacity(&buckets, len(buckets))
// 	return &(ck_pir.StaticDB{NumRows: len(buckets) / bucketLen, RowLen: bucketLen, FlatDb: buckets})
// }
